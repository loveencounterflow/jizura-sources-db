...
order by count;`)).all();
  ...
  demo_read_dump = function() {
    ...
    }, demo_read_dump_ = function({progress}) {
      var Undumper, jzr, line, path, row, statement, undumper, y;
